...
- electron-vite
- pnpm 10
- Node.js 20.19+ 或 22.12+（Vite 7 需要 `crypto.hash`；本机优先 Node 22 / 24，仓库根目录有 `.nvmrc`）
- Grok Build ACP
...
- 当前计划：Computer Use 对标 Codex。说明书 [2026-09-17-computer-use-development.md](docs/superpowers/specs/2026-09-17-computer-use-development.md)。**P3-06 代码已合入 main**（独立设置页 + Agent 自己开右栏 + Native Host Cookie 同步 + 配套针）。下一刀 **P3-07 Helper 任意 App**。开发版 GUI / 真 Chrome unpacked 安装未走查。五条 MUST 未齐，不得宣称已和 Codex 一样。P0-19 GUI 走查仍开放。P1-06～08 与 P2 仍搁置。P3-05 已被 P0-21 取代。
