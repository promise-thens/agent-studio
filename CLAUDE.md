...
- 当前计划：[P0-19 Grok 宿主能力打磨](docs/superpowers/plans/p0-19-grok-host-capability-polish.md)。P1-06～08 与 P2 搁置。P3-05 受管浏览器已被 [P0-21](docs/superpowers/plans/p0-21-host-managed-browser.md) 取代（2026-09-04 确认 Codex 式共享页）；P3-06/07 仍后置。P0-13 代码已落地，开发版 GUI 走查仍是 0 号门。P0-14 Worktree 可与后续分计划并行，不挡宿主能力摊开。
...
- 下一步：P0-21 任务 5 mapper / 截图 Artifact 与开发版 GUI；P0-21a 开发版 GUI 走查（内置页允许软件光标，overlay 已落地，未走查不得宣称可用）；19f 已打开 `browser` L3，后到者不得改回 unsupported。P0-19f 插件虚拟鼠标硬验收仍开放。P0-19e / P0-19d / P0-19c 开发版 GUI 走查仍未跑。P0-19g / P0-19a / GACP-06 / P0-19b 开发版 GUI 走查仍未跑。P0-10C 至 P0-13 开发版走查暂时可以通过。不要加回「继续任务」按钮。文件编辑器另开计划，尚未立项
