...
This project is indexed by GitNexus as **agent-studio** (7736 symbols, 20571 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
