...
- 下一步：P0-19c 任务 3 执行顺序与失败。P0-21 宿主内置浏览器计划已写，不挡 19c。P0-19g / P0-19a / GACP-06 / P0-19b 开发版 GUI 走查仍未跑。P0-10C 至 P0-13 开发版走查暂时可以通过。不要加回「继续任务」按钮。文件编辑器另开计划，尚未立项
- 最近验证：2026-09-07 P0-19c 任务 2。聚焦 `turn-rewind-preview` / `turn-rewind-card` / `task-changes-presentation` 39 tests 已过；文件确认仍走已有 restore IPC，未接线 `startTurn('/rewind')`；开发版 GUI 未走查，不得宣称 GUI 已过
