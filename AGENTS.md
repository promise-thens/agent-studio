...
This project is indexed by GitNexus as **agent-studio** (9890 symbols, 26049 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
