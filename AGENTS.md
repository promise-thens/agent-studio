...
This project is indexed by GitNexus as **agent-studio** (8110 symbols, 21549 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
