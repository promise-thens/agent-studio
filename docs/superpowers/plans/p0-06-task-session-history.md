...
- [x] **第 1 步: 定义持久化白名单与上限**
      说明：总历史 256 MiB、最多 100 个 Project、500 个 Task、每 Task 100 个 Turn、每 Turn 2000 个事件；用户输入最多 64 KiB、单事件 256 KiB、Turn 事件总量 8 MiB，事件块最多 50 条或 512 KiB。sequence 为 Turn 内序号，唯一键为 `(taskId, turnId, sequence)`。
