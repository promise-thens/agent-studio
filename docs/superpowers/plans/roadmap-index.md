...
|       5g | P0-10E  |    4 | [Grok 插件安装与信任](p0-10e-grok-plugin-install-and-trust.md)                               | 待开始                             | P0-10D（config.toml 必须合并写入）       |
