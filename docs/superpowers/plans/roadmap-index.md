...
|        5 | P0-21 |    4 | [宿主内置浏览器（Codex 式共享页）](p0-21-host-managed-browser.md) | 任务 2–4 代码已落地；[P0-21a](p0-21a-host-browser-pointer-and-snapshot.md) overlay 代码已落地；开发版 GUI 未走查 | P0-10D、P0-13、GACP-03 L3；不挡 19b；取代 P3-05 第一波 |
